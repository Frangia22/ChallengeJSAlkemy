            ...
            <div className="container">
                        <table className="table">
                            <thead className="thead">
                                <tr className="tr">
                                    <th className="td hide-field">Operation number</th>
                                    <th className="td hide-field">Concept</th>
                                    <th className="td">$ Amount</th>
                                    <th className="td hide-field">Date</th>
                        ...
                        <tbody className="tbody">
                            <tr className="tr">
                                ...
                                <td className="td hide-field">{ val.concept }</td>
