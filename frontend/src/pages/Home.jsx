                ...
                <div className="container">
                    ...
                    <div className="balance">                      
                        ...
                        <hr/>   
                            <ul className="list py-2">
                                ...
                                <li className="list-balance"><p className="list-item text-success d-flex">$ {balanceList.totalBalance}<img className="img-arrow" src="/flechaarriba.svg" alt=""></img></p></li>
                                :
                                    <li className="list-balance"><p className="list-item text-warning d-flex">$ {balanceList.totalBalance}<img className="img-arrow" src="/flechaabajo.svg" alt=""></img></p></li>
                                }
                            </ul>                                   
                    </div>
                    <div className="container">
                    ...
                    <table className="table">
                        <thead className="thead">
                            <tr className="tr">
                                <th className="th hide-field">Operation number</th>
                                <th className="th">Concept</th>
                                <th className="th">$ Amount</th>
                                <th className="th hide-field">Date</th>
                        ...
                        <tbody className="tbody">
                            <tr className="tr">
                                <td className="td hide-field">{ val.id }</td>
                                <td className="td">{ val.concept }</td>
                                <td className="td">$ { val.amount }</td>
                                <td className="td hide-field">{ val.date }</td>
